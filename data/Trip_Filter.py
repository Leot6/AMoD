"""
filter out the trips starts/ends outside Manhattan area
"""
...
if __name__ == '__main__':
    ...
    # labels' names
    # pickup_time = 'lpep_pickup_datetime'  # for green taxi
    # dropoff_time = 'lpep_dropoff_datetime'
    pickup_time = 'tpep_pickup_datetime'  # for yellow taxi
    ...
    # # read all trips
    # CSV_FILE_PATH = '/Users/leot/Downloads/yellow_tripdata_2016-05.csv'
    ...
    # df6.to_csv('Manhattan-green-taxi-20160501.csv', index=False)

    # # rename the column index
    # df7 = pd.read_csv('Manhattan-green-taxi-20160501.csv')
    ...
    # df7.to_csv('Manhattan-green-taxi-20160501.csv', index=False)

    # # merge green taxi and yellow taxi together
    # df8 = pd.read_csv('Manhattan-green-taxi-20160501.csv')
    # df8['taxi'] = 'green'
    # print('number of green taxi trips:', df8.shape[0])
    # df9 = pd.read_csv('Manhattan-yellow-taxi-20160501.csv')
    # df9['taxi'] = 'yellow'
